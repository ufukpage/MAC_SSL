...
from src.apis import train_network, get_root_logger, set_random_seed
from src.builder import build_model, build_dataset
...
if __name__ == '__main__':
    ...
    # otherwise, if there exists a trained pt_model_3 in work directory, we will resume training from it
