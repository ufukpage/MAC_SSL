...
data = dict(
    videos_per_gpu=16,  # total batch size 8*4 == 32
    workers_per_gpu=4,
    train=dict(
        type='TSNDataset',
        ...
        data_source=dict(
            ...
            ann_file="D:/UCF-101/split/train_split_1.json"  # 'ucf101/annotations/train_split_1.json',
        ),
        backend=dict(
            type='JpegBackend',
    ...
    val=dict(
        ...
        data_source=dict(
            type='JsonClsDataSource',
            ann_file="D:/UCF-101/split/test_split_1.json"  # 'ucf101/annotations/train_split_1.json',
        ),
        backend=dict(
            type='JpegBackend',
            frame_fmt='frame{:06d}.jpg'
