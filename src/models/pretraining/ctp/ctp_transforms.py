...
class PatchMask(BaseTransform):
    ...
    def __init__(self,
        ...
        Args:
            ...
            label_prob (float): how many percentages of frames will be
                ...
                force the pt_model_3 to infer the patch positions. (see MRM module
                in the paper).
        """
    ...
    def get_transform_param(self, data: List[np.ndarray], *args, **kwargs):
        ...
        for i in range(len(boxes)):
            ...
            patches_list.append(patches)   # trajectory x patch_size --> patch
            alphas_list.append(alphas)  # trajectory x patch_size --> mask
            label_list.append(labels)   # drop prob
    ...
    def pick_alphas(self,
        ...
        for frame_idx in range(num_frames):
            ...
            i_alpha = i_alpha * frame_alphas[frame_idx] # frame alhpas 1 0 arasindan disari cikiyor
