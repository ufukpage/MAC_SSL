# obtained from https://github.com/PeihaoChen/RSPNet/blob/main/models/s3dg.py
import torch
...
class S3D_G(BaseBackbone):
    def __init__(self, in_channel=3, gate=True,  pretrained=None):
