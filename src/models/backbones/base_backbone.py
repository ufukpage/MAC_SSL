...
class BaseBackbone(nn.Module):
    ...
    def init_from_pretrained(self, pretrained, logger) -> None:
        """ Initialize pt_model_3 weights from a pretrained pt_model_3. The pretrained
        pt_model_3 can be produced by some proxy task, e.g. CtP and SpeedNet, or
        ...
        Args:
            pretrained (str): pretrained pt_model_3 path. (something like *.pth)
